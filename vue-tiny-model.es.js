...
function defineModel(defineProps) {
    function instance(props) {
        ...
        const extraProps = Object.keys(binds).reduce((r, k) => {
            r[k] = createComputedProp(context, binds[k]);
            return r;
        }, {});
        const extraMethods = Object.keys(methods).reduce((r, k) => {
            r[k] = () => methods[k].apply(context.model);
            return r;
        }, {});
        context.model = reactive(Object.assign(Object.assign({}, toRefs(context.model)), extraProps));
        return Object.assign(context.model, extraMethods);
    }
    return class {
        constructor(props) {
...
function createComputedProp(context, v) {
    ...
    return computed({
        ...
        set: set ? (...args) => set.apply(context.model, args) : undefined,
    });
}
// todo
// function listen() {}
...
export { bind, defineModel, getter, model };
